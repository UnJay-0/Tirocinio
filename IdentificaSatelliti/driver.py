...
if __name__ == '__main__':
    ...
    sinousoids[1] = generateValues(1, 0.05, 0, sinousoids[0])
    sinousoids[2] = generateValues(10, 3, math.pi, sinousoids[0])
    sinousoids[3] = generateValues(4, 0.007, math.pi/2, sinousoids[0])
